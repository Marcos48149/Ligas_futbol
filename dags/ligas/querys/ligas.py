...
default_arguments = {   'owner': 'marcos',
                        'email': 'marcosgomez48149@gmail.com',
                        'retries':1 ,
                        'retry_delay':timedelta(minutes=5)}


with DAG('LIGA_FUTBOL',
         default_args=default_arguments,
         description='Extraccion de datos de ligas futbol' ,
         ...
         upload_stage = SnowflakeOperator(
                    ...
                    sql='./upload_stage.sql',
                    snowflake_conn_id='snow_ligas1',
